<div class="return-item border rounded-3 p-3 bg-white shadow-sm">
    <div class="row g-3 align-items-end">
        ...
        <div class="col-lg-3">
            ...
            <input type="number" class="form-control" min="1" data-name="items[__INDEX__][cantidad_devuelta]" name="items[{{ $index }}][cantidad_devuelta]" value="{{ $item['cantidad_devuelta'] ?? 1 }}" required>
        </div>
